...
parser.add_argument('--use_model', type=str, default='self', help='self, multi, self_doc2vec or multi_doc2vec')
...
if args.use_model == 'multi':
    use_multi = True
elif args.use_model == 'self_doc2vec':
    use_doc2vec = True
elif args.use_model == 'multi_doc2vec':
